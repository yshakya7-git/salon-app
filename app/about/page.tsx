...
import expertone from "../../public/expertone.jpg";
import experttwo from "../../public/experttwo.jpg";
import expertthree from "../../public/expertthree.jpg";
    ...
    <div className="">
      ...
      <div className="space-y-6 p-4 ">
        <div className="flex justify-between gap-8 items-center">
          <section className="w-full md:w-[60%] space-y-4 ">
            <div className="flex items-center gap-4">
              <SparkleIcon width={22} height={22} />
              <h2 className="text-primary uppercase text-sm lg:text-2xl font-semibold">
                Our Mission
              </h2>
            </div>

            <p className="border-l-4 border-primary pl-4 mt-2 text-font dark:text-foreground text-justify font-medium lg:text-lg">
            ...
            <p className="text-[#181114B2] dark:text-foreground/90 text-sm lg:text-base text-justify mt-4 font-medium">
          ...
          <section className="w-[45%] hidden md:block">
            <Image
              src={aboutImg}
              alt="AboutImg"
              className="rounded-2xl h-full lg:h-162.5"
            />
          </section>
        </div>
            ...
            {experts.map((expert) => (
              <div key={expert.id}>
                <Image
                  src={expert.image}
                  alt={expert.name}
                  className="w-full h-150 rounded-lg mt-4"
                />
      ...
      <section className="bg-white dark:bg-black px-4 py-12 space-y-4">
